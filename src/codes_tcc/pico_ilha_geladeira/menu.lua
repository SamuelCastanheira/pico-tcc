...
local background = Objeto.create({'%', x=0.5, y=0.5, w=1, h=1},
                            "../../../assets/imgs/background_menu.png")
        
local logo = Objeto.create({'%', x=0.5, y=0.225, w=0.45, h=0.45},
                "../../../assets/imgs/logo.png")

local bt_jogar = Objeto.create({'%', x=0.5, y=0.5, w=0.55, h=0.2},
                            "../../../assets/imgs/botoes/b_jogar.png",
                            "../../../assets/imgs/botoes/b_jogar_clicado.png")
local bt_personalizar = Objeto.create({'%', x=0.5, y=0.7, w=0.55, h=0.2},
                                "../../../assets/imgs/botoes/b_personalizar.png",                                
                                "../../../assets/imgs/botoes/b_personalizar_clicado.png")                                
local bt_sair = Objeto.create({'%', x=0.5, y=0.9, w=0.55, h=0.2},
                            "../../../assets/imgs/botoes/b_sair.png",
                            "../../../assets/imgs/botoes/b_sair_clicado.png")
